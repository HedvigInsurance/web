        ...
        <div className="Container u-md-spaceMT10 u-lg-spaceMT10 u-spaceMB5 u-md-spaceMB3 u-lg-spaceMB3">
          <div className="u-maxWidth1of1">
            <section className="">
              <div className="u-spaceMT5">
                ...
                <p className="u-spaceMB9">
                  ...
                  för att tillhandahålla dig försäkring, men också för att
                  anpassa våra erbjudanden till dig och för att utveckla och
                  förbättra våra produkter och service.
                </p>
                <p className="u-spaceMB9">
                  När vi säger personuppgifter menar vi information som direkt
                  eller indirekt kan hänföras till dig som individ. För oss är
                  det viktigt att det är tydligt för dig vilka uppgifter vi
                  samlar in, och hur vi använder dem. Därför innehåller den här
                  policyn detaljerad information om allt som har med
                  behandlingen av dina uppgifter att göra. Vi hanterar dina
                  personuppgifter i enlighet med Dataskyddsförordningen (även
                  kallat GDPR), annan tillämplig lagstiftning och föreskrifter
                  från olika myndigheter. Alla uppdateringar som rör
                  behandlingen av dina personuppgifter meddelas på vår hemsida.
                </p>
                <p className="u-spaceMB9">
            ...
            <section className="">
              ...
              <div className="">
                <p className="u-spaceMB9">
                  ...
                  exempel på information vi kan komma att behandla.
                  Informationen behöver inte gälla för dig, utan är exempel på
                  typer av informationen vi kan behandla om våra användare.
                </p>
                ...
                <p className="u-spaceMB9">
                  ...
                  service genom Hedvigs kommunikationskanaler, för att
                  kommunicera med dig och för att hantera olika typer av
                  betalningar (exempelvis utbetalning av ersättning om du har
                  haft en skada).
                </p>
                ...
                <p className="u-spaceMB9">
                  Namn, kontaktuppgifter, familjestatus, födelsedatum,
                  anställning och arbetsgivare, marknadsföringspreferenser.
                </p>
                <h4 className="u-spaceMT8">
                ...
                <p className="u-spaceMB9">
                  Bankkontonummer, kontouppgifter och annan
                ...
                <p className="u-spaceMB9">
                  Vi samlar in försäkringsinformation (samt skadeinformation)
                  för att ingå försäkringsavtalet och för att reglera skador. Vi
                  eller våra samarbetspartners kan till exempel behöva uppgifter
                  om den egendom som försäkringen omfattar eller
                  journaluppgifter för att reglera om du blivit sjuk eller råkat
                  ut för en olycka utomlands. Här listar vi fler exempel på
                ...
                <p className="u-spaceMB9">
                  ...
                  egenskaper, fastighetens skick, byggnadens ålder och
                  tillbehör, boende och hyresgäster, larm och låsskydd.
                </p>
                ...
                <p className="u-spaceMB9">
                  Förutom allmän information kan vi också komma att samla in
                  viss känslig information om dig. Nedan ser du exempel på
                  sådana uppgifter.
                </p>
                ...
                <p className="u-spaceMB9">
                  ...
                  ansvars- eller överfallsskyddsskador till följd av en
                  brottslig gärning. Vi samlar också in nödvändig information
                  för att förhindra penningtvätt, försäkringsbedrägerier och
                  utreda vissa svåra försäkringsfall.
                </p>
                <h3 className="u-spaceMT8 u-spaceMB10 u-fontSize9 u-lg-fontSize8">
                  Övrigt
                </h3>
                ...
                <p className="u-spaceMB9">
                  ...
                  analyserar och lyssnar på röstinspelningar du har gjort i
                  appen.
                </p>
                <h4 className="u-spaceMT8">Bilder och videoinspelningar</h4>
                <p className="u-spaceMB9">
                  Vi analyserar och tittar på bilder och videoinspelningar som
                  rör försäkringsskador, som du har laddat upp i appen eller
                  skickat till oss.
                </p>
            ...
            <section className="">
              ...
              <div className="">
                <p className="u-spaceMB9">
                  Vi samlar in uppgifter om dig från olika källor beroende på
                  din relation med oss. Nedan listas olika exempel på data vi
                  kan samla in.
                </p>
                ...
                <p className="u-spaceMB9">
                  Vi kan inhämta uppgifter från dig när du interagerar med oss
                  via olika kommunikationskanaler (t.ex. vår hemsida eller app)
                  och visar intresse för köp av försäkring, köper försäkring
                  eller anmäler en skada.
                </p>
                ...
                <p className="u-spaceMB9">
                  För att utreda och reglera skador kan vi inhämta uppgifter
                  från samarbetspartners, vårdgivare, andra försäkringsbolag,
                  polisen och andra myndigheter och institutioner, för att
                  utreda din och andra parters rätt till ersättning.
                </p>
            ...
            <section className="">
              ...
              <div className="">
                ...
                <p className="u-spaceMB9">
                  ...
                  sådant avtal. Informationen används för att vi ska kunna ge
                  dig ett korrekt pris sett till din riskprofil och för att se
                  till att din försäkring har rätt omfattning. Vi använder också
                  uppgifterna för administration och för att erbjuda dig
                  tjänster som har anknytning till din försäkring och engagemang
                  med Hedvig.
                </p>

                <h4 className="u-spaceMT8">Försäkringspartner</h4>
                <p className="u-spaceMB9">
                  Vi kan komma att sammanställa och lämna ut personuppgifter
                  till vår försäkringsgivare.
                </p>
                ...
                <p className="u-spaceMB9">
                  Vi använder dina personuppgifter för att våra
                  samarbetspartners ska kunna erbjuda tjänster som är relaterade
                  till vår försäkring.
                </p>
                ...
                <p className="u-spaceMB9">
                  ...
                  röstinspelningar, bilder och videoinspelningar för att
                  utveckla vår verksamhet, våra produkter och tjänster och
                  genomföra marknadsundersökningar och andra analyser.
                </p>

                <h4 className="u-spaceMT8">Marknadsföring</h4>
                <p className="u-spaceMB9">
                  Vi samlar in och analyserar personuppgifter, som beteende i
                  vår app och på vår hemsida (inklusive geobaserad information)
                  för att kunna skicka erbjudanden om försäkring och annan
                  användbar information anpassad för dig. Du kan komma att få
                ...
                <p className="u-spaceMB9">
                  ...
                  enligt gällande rätt och att på begäran kunna svara
                  myndigheter när de har rätt att få del av uppgifter enligt
                  lag.
                </p>

                <h4 className="u-spaceMT8">Upprättande av statistik</h4>
                <p className="u-spaceMB9">
                  Vi använder personuppgifter för att ta fram statistiskt
                  underlag för våra riskbedömningar och försäkringsprodukter.
                </p>
              </div>
            </section>
            ...
            <section className="">
              ...
              <div className="">
                ...
                >
                  <li>
                    Behandlingen är nödvändig för att fullgöra ett avtal i
                    vilket personen i fråga är part eller för att vidta åtgärder
                    på begäran av sådan person innan ett sådant avtal ingås. Det
                    kan t.ex. röra sig om information om försäkringstagaren,
                    andra försäkrade, den försäkrade egendomen och risken
                    relaterad till försäkringen samt uppgifter som är nödvändiga
                    för att fastställa rätt till försäkringsersättning.
                  </li>
                  <li>
                    Du kan ha gett oss ditt samtycke till att dina
                    personuppgifter får behandlas för vissa ändamål. Du har i
                    sådant fall när som helst rätt att återkalla ditt samtycke.
                    Återkallandet av samtycket kommer dock inte att påverka
                    lagligheten av behandlingen som grundat sig på samtycket,
                    innan detta återkallas. Observera att en återkallelse av
                    samtycke kan påverka rätten till försäkring eller
                    ersättning.
                  </li>
                  <li>
                    Behandlingen är nödvändig för ändamål som rör Hedvigs eller
                    en tredje parts berättigade intressen under förutsättning
                    att din integritet är tillräckligt skyddad. Denna grund är
                    tillämplig på behandling i syfte att motverka bedrägerier,
                    för direktmarknadsföring, för att underhålla och utveckla
            ...
            <section className="">
              ...
              <div className="">
                <p className="u-spaceMB9">
                  På Hedvig kan vi fatta beslut med automatik, dvs. utan
                  mänsklig påverkan. Det rör sig t.ex. automatisk prissättning,
                  riskanalys och utbetalning av ersättning. Genom att
                  automatisera dessa processer kan vi erbjuda dig som användare
                  bättre och snabbare hjälp.
                </p>
                ...
                <p className="u-spaceMB9">
                  ...
                  oss, och analyseras gentemot ditt försäkringsvillkor. Beslut
                  kan innefatta såväl rätt till ersättning som ersättningens
                  storlek. Om du inte är nöjd med ett beslut har du alltid rätt
                  att kontakta oss.
                </p>
                ...
                <p className="u-spaceMB9">
                  ...
                  signerar upp som användare. Automatiserade beslut baseras på
                  den information som tillhandahållits oss och våra system
                  beräknar sedan priset för försäkringen baserat på uppgifter vi
                  får av dig, samt externa datakällor. Automatisk
            ...
            <section className="">
              ...
              <div className="">
                ...
                <p className="u-spaceMB9">
                  ...
                  uppfylla det syfte för vilket vi sparar dem eller den längre
                  tid som i förekommande fall uppställs av gällande lag. Du har
                  när som helst rätt att inkomma med en begäran om att dina
                  uppgifter raderas.
                </p>
                <p className="u-spaceMB9">
                  Vi vidtar alltid lämpliga tekniska, rättsliga och
                  organisatoriska säkerhetsåtgärder för att skydda din
                  integritet. Om någon annan part utanför Hedvig behandlar
                  personuppgifter för vår räkning ansvarar vi för att det utförs
                  med omsorg och med krav på att Dataskyddsförordningens krav
            ...
            <section className="">
              ...
              <div className="">
                <p className="u-spaceMB9">
                  ...
                  endast när det finns ett lagligt stöd för sådan överföring
                  eller att berörda individer samtyckt till detta. Behandling av
                  personuppgifter som sker genom personuppgiftsbiträden utgör
                  inte en sådan överföring utan anses ske inom ramen för Hedvigs
                  kontroll.
                </p>
                ...
                >
                  ...
                  <li>
                    ...
                    kontaktuppgifter kan komma att delas om det är nödvändigt
                    för att besiktiga eller reglera en skada;
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    nödvändigt för att kunna reglera en skada eller för att
                    kunna regressa mot sådant försäkringsbolag;
                  </li>
                  <li>
                    <b>Myndigheter och nämnder</b> – vi tillhandahåller
                    uppgifter till myndigheter och nämnder när vi är skyldiga
                    att tillhandahålla informationen för att fullgöra en
                    rättslig förpliktelse eller för att tillvarata våra
                    intressen i ett rättsligt förfarande;
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    specialistleverantörer för analys, underhåll och utveckling
                    av Hedvigs IT-system;
                  </li>
                  <li>
                    <b>GSR</b> – genom vår försäkringsgivare har vi tillgång
                    till ett för försäkringsbranschen gemensamt
                    skadeanmälningsregister (GSR). Detta register innehåller
                    vissa uppgifter om skadan samt uppgift om vem som begärt
                    ersättning och används endast i samband med skadereglering.
                    Det innebär att vi kan få reda på om du tidigare anmält
                    någon skada hos annat försäkringsbolag. Ändamålet med GSR är
                    att tillhandahålla ett underlag till försäkringsföretag för
                    att identifiera oklara försäkringsfall. Därigenom kan
                    företagen motverka utbetalning av ersättningar som baseras
                    på oriktiga uppgifter. Uppgifterna kan även användas i
                    avidentifierad form för statistiska ändamål.
                  </li>
                </ul>

                <p className="u-spaceMB9">
                  Personuppgiftsansvarig för GSR är Skadeanmälningsregister
                  (GSR) AB, Box 24171, 104 51 Stockholm. Se{' '}
            ...
            <section className="">
              ...
              <div className="">
                <p className="u-spaceMB9">
                  Dina personuppgifter lagras inom den Europeiska unionen (EU)
                  och Europeiska ekonomiska samarbetsområdet (EES). På grund av
                  globaliseringen och den tekniska utvecklingen kan vi i
                  begränsad omfattning komma att överföra eller tillåta åtkomst
                ...
                <p className="u-spaceMB9">
                  ...
                  exempel beträffande molntjänstleverantörer med verksamhet i
                  USA. All sådan överföring sker med tillämpning av
            ...
            <section className="">
              ...
              <div className="">
                <p className="u-spaceMB9">
                  ...
                  personuppgifter på ett lagligt, transparent och öppet sätt,
                  och att dina uppgifter är korrekta och aktuella. Du kan se
                  viss information under din profilsida i appen. Om du önskar
                  mer information är det bara att beställa en kopia av de
                ...
                <p className="u-spaceMB9">
                  ...
                  information som du tycker är felaktig. Du har också alltid
                  rätt att begära att dina personuppgifter raderas, om det inte
                  finns laglig grund för vår hantering. Du kan också i vissa
                  fall begära att behandlingen av dina personuppgifter
                  begränsas.
                </p>

                <p className="u-spaceMB9">
                  Viss information kan vara undantagen från din rätt till
                  radering enligt gällande rätt. På din begäran kan en kopia av
                  de personuppgifter som du tillhandahållit oss överföras av oss
            ...
            <section className="">
              ...
              <div className="">
                <p className="u-spaceMB9">
                  ...
                  lagstiftning. Hedvig har också utsett ett dataskyddsombud för
                  personuppgiftsbehandlingen, se nedan.
                </p>

                <p className="u-spaceMB9">
                  Du har rätt att, enligt gällande lag, begära tillgång till och
                  rättelse eller radering av dina personuppgifter, begränsning
                  av personuppgiftsbehandling som rör dig, att invända mot
                  personuppgiftsbehandling, samt till dataportabilitet. Du har
                  rätt till detta helt utan kostnad. Vid ogrundade eller
                  orimliga förfrågningar (t.ex. på grund av att de görs mycket
                  ofta) får Hedvig ta ut en administrativ avgift – du kommer i
                  sådant fall att meddelas om detta på förhand.
                </p>

                <p className="u-spaceMB9">
                  Om du har några frågor kring hur vi behandlar dina
                  personuppgifter, kontakta oss! Du kan antingen maila direkt
                  till Hedvigs support på{' '}
                ...
                <p className="u-spaceMT8 u-spaceMB9">
                  Skulle du efter kontakten med oss fortfarande vara missnöjd
                  kan du vända dig till Datainspektionen som är
                  tillsynsmyndighet för personuppgiftsbehandling, och till
                  vilken du kan anmäla ditt klagomål.
                </p>
