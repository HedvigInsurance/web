      ...
      <div className="Container u-md-spaceMT10 u-lg-spaceMT10 u-spaceMB5 u-md-spaceMB3 u-lg-spaceMB3">
        <div className="u-maxWidth1of1">
          ...
          <section className="">
            ...
            <div className="">
              <p className="u-lg-fontSize9 u-spaceMB9">
                Om du har ett allmänt klagomål eller är missnöjd med någonting i
                ett skadeärende, kontakta Hedvig direkt via din app eller maila{' '}
                <a href="mailto:hedvig@hedvig.com">hedvig@hedvig.com</a>.
              </p>
              <p className="u-lg-fontSize9 u-spaceMB9">
                Du kan också vända dig till Konsumentvägledningen i din kommun
                eller till Konsumenternas Försäkringsbyrå. Vid tvist kan du
                vända dig till Allmänna reklamationsnämnden eller till allmän
                domstol.
              </p>
            </div>
          </section>
          <section className="">
            ...
            <div className="">
              <p className="u-lg-fontSize9 u-spaceMB9">
                Hedvig, och i förekommande fall International Insurance Company
                of Hannover SE, använder personuppgifter i administration,
                skadereglering, marknads- och kundanalys, produktutveckling,
                marknadsföring och för statistiska ändamål. Vi behandlar
                uppgifterna i enlighet med Personuppgiftslagen (1998:204).
              </p>
              <p className="u-lg-fontSize9 u-spaceMB9">
                Personuppgifterna kan komma att kompletteras med uppgifter ur
                offentliga register, främst statens person- och adressregister
                (SPAR) och kan komma att lämnas ut till samarbetspartners. I
                vissa fall är vi också enligt lag skyldiga att lämna ut
                uppgifter till bland andra Finansinspektionen och Skatteverket.
                Du har rätt att ansöka om att få veta vilka personuppgifter vi
                har om dig och begära rättelse av felaktiga uppgifter.
              </p>
            </div>
          </section>
          <section className="">
            ...
            <div className="">
              <p className="u-lg-fontSize9 u-spaceMB9">
                En cookie är en liten datafil som lagras i din dator. Hedvig
                värnar om din integritet och ditt förtroende är vår mest
                värdefulla tillgång. Här förklaras hur vi samlar in och använder
                cookies och hur vi skyddar din integritet i samband med detta.
              </p>
              ...
              <p className="u-lg-fontSize9 u-spaceMB9">
                ...
                användas i de fall vi använder externa tjänster för att
                förbättra produkten. Hedvig använder två typer av cookies, dels
              ...
              <p className="u-lg-fontSize9 u-spaceMB9">
                ...
                bör förbättra, att analysera hur våra mailutskick fungerar och
                att vi skickar information som du som användare uppskattar, samt
              ...
              <p className="u-lg-fontSize9 u-spaceMB9">
                ...
                Hedvig och andra från att registrera cookies på din dator.
                Sådana inställningar innebära dock att vissa funktioner på de
                flesta webbplatser inte kommer att fungera.
              </p>
              <p className="u-lg-fontSize9 u-spaceMB9">
                Om du vill kan du i de flesta webbläsares inställningar välja
                att bara stänga av spårning, vilket innebär att Hedvig inte
                samkör data från våra egna och i förekommande fall våra partners
                webbplatser.
              </p>
              <p className="u-lg-fontSize9 u-spaceMB9">
                För att göra samma sak på din telefon kan du för iOS under
                integritets- och reklaminställningar välja att begränsa
                spårning. För Android gör du detta under Google-inställningar
                och annonser.
              </p>
            </div>
          </section>
          <section className="">
            ...
            <div className="">
              ...
              <address className="u-lg-fontSize9 u-fontStyleNormal">
                Box 7821<br />
                103 97 Stockholm<br />
