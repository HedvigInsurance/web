            ...
            <section className="">
              ...
              <div className="">
                <p className="u-spaceMB9">
                  Hedvig står under Finansinspektionens tillsyn som förmedlare
                  av försäkringar och på våra försäkringsavtal tillämpas
            ...
            <section className="">
              ...
              <div className="">
                <p className="u-spaceMB9">
                  ...
                  värdefulla tillgång. Här förklaras hur vi samlar in och
                  använder cookies och hur vi skyddar din integritet i samband
                  med detta.
                </p>
                ...
                <p className="u-spaceMB9">
                  ...
                  förbättra produkten. Hedvig använder två typer av cookies,
                  dels sessionsbaserade cookies, som försvinner så fort du
                  stänger ner din webbläsare, men även mer långlivade cookies
                  för vissa syften.
                </p>
                <h3 className="u-spaceMT8 u-spaceMB10 u-fontSize11 u-md-fontSize10">
                  Syftet med cookies
                ...
                <p className="u-spaceMB9">
                  ...
                  användarbeteende anonymt för att veta vilka delar av tjänsten
                  vi bör förbättra, att analysera hur våra mailutskick fungerar
                  och att vi skickar information som du som användare
                  uppskattar, samt för att komma ihåg inställningar och andra
                  val som du gör på våra webbplatser.
                </p>
                <h3 className="u-spaceMT8 u-spaceMB10 u-fontSize11 u-md-fontSize10">
                  Hantera dina cookies
                </h3>
                <p className="u-spaceMB9">
                  Om du inte vill att vi använder cookies kan du enkelt stänga
                  av detta. I din webbläsare kan du göra inställningar som
                  hindrar Hedvig och andra från att registrera cookies på din
                  dator. Sådana inställningar innebära dock att vissa funktioner
                  på de flesta webbplatser inte kommer att fungera.
                </p>
                <p className="u-spaceMB9">
                  Om du vill kan du i de flesta webbläsares inställningar välja
                  att bara stänga av spårning, vilket innebär att Hedvig inte
                  samkör data från våra egna och i förekommande fall våra
                  partners webbplatser.
                </p>
                <p className="u-spaceMB9">
