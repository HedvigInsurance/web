  ...
  <main className="Terms">
    ...
    <article className="pure-g pure-centered Terms__text">
      <div className="pure-u-1-1 pure-u-md-3-5">
        <section>
          <p>
            Här hittar du våra olika försäkringsvillkor. Där i står det vad din försäkring gäller
            för. Vi har gjort vårt allra bästa för att de ska vara enkla att läsa, men har du några
            frågor är det bara att kontakta Hedvig direkt via din app eller maila
            <a href="mailto:hedvig@hedvig.com"> hedvig@hedvig.com</a>. I appen hittar du en tydlig
            översikt över allt din försäkring omfattar, och hur den gäller för olika saker.
          </p>
          <p>
            Det är viktigt att du läser villkoret och ditt försäkringsbrev. Skador ersätts alltid
            enligt det villkor som gäller när en skada inträffar.
          </p>
          <p>
            ...
            begränsningar. Förköpsinformation är sådan information som du har rätt att få innan du
            köper en försäkring. Informationen finns så klart tillgänglig i appen också.
          </p>
        </section>
          ...
          <div className="pure-u-1-1 pure-u-md-1-2">
            ...
            <p>
              <span>
                ...
                och vill att din hyresvärds saker och lägenhet ska täckas av försäkringen
              </span>
            </p>
          </div>
        </section>
